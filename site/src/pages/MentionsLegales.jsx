      ...
      <main className="legal-page" style={{ paddingTop: '7.5rem', paddingBottom: '5rem', minHeight: '80vh' }}>
        <div className="container" style={{ maxWidth: '840px' }}>
          ...
          <nav aria-label="Fil d'Ariane" style={{ marginBottom: '2rem', fontSize: '0.875rem', color: 'var(--c-muted)' }}>
            <a href="/" style={{ color: 'var(--c-accent)', textDecoration: 'none' }} onClick={handleLinkClick}>Accueil</a>
          ...
          <div className="legal-content" style={{ lineHeight: '1.8', color: 'var(--c-text)', fontSize: '1rem' }}>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <p>
                ...
                <a href="https://www.eclatbrillance.com" style={{ color: 'var(--c-accent)', fontWeight: 500 }} onClick={handleLinkClick}>
              ...
              <ul style={{ paddingLeft: '1.25rem', marginTop: '0.75rem', marginBottom: '1rem', display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                ...
                <li>
                  ...
                  <a href={`tel:${phone.replace(/\s+/g, '')}`} style={{ color: 'var(--c-accent)' }} onClick={handleLinkClick}>
                    <EditableText path="legal.phone" tag="span">{phone}</EditableText>
                  </a>
                </li>
                <li>
                  <strong>Email de contact : </strong>
                  <a href={`mailto:${email}`} style={{ color: 'var(--c-accent)' }} onClick={handleLinkClick}>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <ul style={{ paddingLeft: '1.25rem', marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                ...
                <li>
                  ...
                  <a href={hostWebsite} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--c-accent)' }} onClick={handleLinkClick}>
                    <EditableText path="legal.hostWebsite" tag="span">{hostWebsite}</EditableText>
                  </a>
                </li>
                <li>
                  <strong>Contact : </strong>
                  <EditableText path="legal.hostContact" tag="span">{hostContact}</EditableText>
                </li>
              </ul>
            </section>
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <p>
                  ...
                  <EditableText path="legal.director" tag="span">{director}</EditableText> – <EditableText path="legal.companyName" tag="span">{companyName}</EditableText>, <EditableText path="legal.address" tag="span">{address}</EditableText>.
                </p>
                <p>
                ...
                <p>
                  ...
                  <a href={`mailto:${email}`} style={{ color: 'var(--c-accent)', fontWeight: 500 }} onClick={handleLinkClick}>
                    <EditableText path="legal.email" tag="span">{email}</EditableText>
                  </a>{' '}
            ...
            <section style={{ marginBottom: '2.5rem' }}>
              ...
              <p style={{ marginTop: '0.5rem' }}>
                ...
                <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--c-accent)' }} onClick={handleLinkClick}>
            ...
            <div style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid var(--c-line)' }}>
              <a href="/" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }} onClick={handleLinkClick}>
